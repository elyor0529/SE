...
namespace SE.Model
{
    public sealed class StorageDbContext : DbContext
    {
        ...
        public StorageDbContext() : base(MainSettings.DatabaesConnectionStringName)
        {
            ReConfig();
        }

        public StorageDbContext(DbConnection connection)
            : base(connection, true)
        {
            ReConfig();
        }

        public DbSet<ResultHistory> Histories { get; set; }

        public DbSet<SearchProvider> Providers { get; set; }
